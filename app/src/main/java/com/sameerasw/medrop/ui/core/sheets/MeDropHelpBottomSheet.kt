...
import com.sameerasw.medrop.ui.components.HelpAndGuidesContent

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MeDropHelpBottomSheet(onDismissRequest: () -> Unit) {
        ...
        LazyColumn(
            ...
            item {
                FlowRow(
                    ...
                    Button(
                        onClick = {
                            val websiteUrl = "https://github.com/sameerasw/MeDrop"
                        ...
                        onClick = {
                            ...
                            val emailIntent =
                                Intent(Intent.ACTION_SENDTO, mailUri).apply {
                                    putExtra(Intent.EXTRA_SUBJECT, "Hello from MeDrop")
                                }
                            try {
